<template>
    <div id="container">
        ...
        <button @click="addProject" class="btn" v-if="!this.id"
            :disabled="title.length === 0 || detail.length === 0">Add Project</button>
        <button @click="updateProject" class="btn" v-if="this.id"
            :disabled="title.length === 0 || detail.length === 0">Update Project</button>
    </div>
</template>
